"""
Django settings for light_novel project.
...
SECRET_KEY = '6-eepm#)97)0wf7nx*5tp^5q3!v%4mlxv$9^t(#3kx*6n=cm80'
...
WSGI_APPLICATION = 'light_novel.wsgi.application'
...
STATIC_ROOT = os.path.join(os.path.dirname(
    BASE_DIR), "static_env", "static_root")
